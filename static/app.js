  ...
  try {
    ...
    if (data.prediction === 1) {
      ...
      const toxicResponses = [
        `<div class="result-heading">YIKES! (${formattedScore})</div>
        ...
        `<div class="result-heading">DANGER ZONE (${formattedScore})</div>
        ...
        `<div class="result-heading">WHOA THERE (${formattedScore})</div>
      ...
      const borderlineResponses = [
        `<div class="result-heading">PROCEED WITH CAUTION (${formattedScore})</div>
        ...
        `<div class="result-heading">QUESTIONABLE (${formattedScore})</div>
        ...
        `<div class="result-heading">TREAD LIGHTLY (${formattedScore})</div>
      ...
      const cleanResponses = [
        `<div class="result-heading">ALL CLEAR (${formattedScore})</div>
        ...
        `<div class="result-heading">PERFECTLY SAFE (${formattedScore})</div>
        ...
        `<div class="result-heading">PRISTINE (${formattedScore})</div>
